...
const newsTemplates: NewsTemplate[] = [
  {
    title: '304 不锈钢网篮在医疗消毒领域的应用优势',
    keywords: ['304 不锈钢', '医用', '消毒', '医疗'],
    baseContent: '304 不锈钢网篮作为医疗器械消毒的重要载体，凭借其优异的耐腐蚀性和耐高温性能，在现代医疗系统中发挥着不可替代的作用。本产品采用优质 304 不锈钢材料精制而成，符合医用级标准，能够承受高温高压灭菌环境的严苛要求。',
  },
  {
    title: '长方形不锈钢网筐在食品加工中的创新应用',
    keywords: ['长方形', '网筐', '油炸', '蒸煮', '食品'],
    baseContent: '长方形不锈钢网筐专为食品加工行业设计，适用于油炸、蒸煮等多种烹饪工艺。其独特的结构设计确保了良好的沥水效果，同时便于操作人员抓取和搬运，大大提高了食品加工的效率。',
  },
  {
    title: '圆形不锈钢过滤网篮的精密过滤技术解析',
    keywords: ['圆形', '过滤', '网篮', '精密'],
    baseContent: '圆形不锈钢过滤网篮采用精密焊接工艺，网孔均匀分布，能够实现高效的固液分离。产品广泛应用于化工、制药、食品等行业，满足不同场景下的过滤需求。',
  },
  {
    title: '工业级不锈钢清洗网篮的技术规格与选型指南',
    keywords: ['清洗', '网篮', '工厂', '工业'],
    baseContent: '工业级不锈钢清洗网篮是工厂生产线上的重要辅助设备，用于零部件清洗、烘干等工序。选择合适的网篮规格对于提高清洗效率、降低能耗具有重要意义。',
  },
  {
    title: '医用不锈钢网筐的消毒灭菌标准与认证',
    keywords: ['医用', '消毒', '网筐', '医疗'],
    baseContent: '医用不锈钢网筐必须通过严格的消毒灭菌认证，确保在医疗环境中的安全使用。我们的产品符合国家医疗器械相关标准，已通过多项权威认证。',
  },
  {
    title: '304 不锈钢材质在网篮制造中的核心优势',
    keywords: ['304 不锈钢', '材质', '网篮', '工厂'],
    baseContent: '304 不锈钢作为一种通用型不锈钢材料，具有良好的耐腐蚀性、耐热性和加工性能，是制造各类网篮、网筐的理想选择。相比其他材质，304 不锈钢网篮使用寿命更长，维护成本更低。',
  },
  {
    title: '定制化不锈钢网筐解决方案助力企业提质增效',
    keywords: ['定制', '网筐', '工厂', '沥水'],
    baseContent: '针对不同行业的特殊需求，我们提供定制化不锈钢网筐解决方案。从尺寸规格到网孔大小，从结构设计到表面处理，每一个细节都根据客户的实际应用场景进行优化设计。',
  },
  {
    title: '不锈钢油炸网篮在高温环境下的稳定性测试',
    keywords: ['油炸', '网篮', '高温', '食品'],
    baseContent: '油炸网篮需要长期在高温油环境中工作，对材料的稳定性和安全性提出了极高要求。我们的 304 不锈钢油炸网篮经过严格的高温测试，确保在 200℃以下环境中长期使用不变形、不释放有害物质。',
  },
  {
    title: '精密过滤网筐在制药行业的应用案例分享',
    keywords: ['过滤', '网筐', '制药', '医疗'],
    baseContent: '制药行业对过滤设备的精度和洁净度要求极高。我们的精密过滤网筐已成功应用于多家知名制药企业，在原料药过滤、中间体分离等环节表现出色，获得了客户的一致好评。',
  },
  {
    title: '不锈钢网篮表面处理的多种工艺对比分析',
    keywords: ['网篮', '处理', '工厂', '304 不锈钢'],
    baseContent: '不锈钢网篮的表面处理工艺直接影响产品的外观质量和耐腐蚀性能。常见的处理方式包括抛光、喷砂、酸洗钝化等，不同工艺各有优劣，需要根据具体应用场景进行选择。',
  },
]
