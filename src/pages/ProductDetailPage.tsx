...
export default function ProductDetailPage() {
  ...
  const images = ((product.images as string[] | null) || []) as unknown as string[]
  const nextImage = () => {
            ...
            >
              <div className="bg-white rounded-xl overflow-hidden shadow-sm card-hover">
                <div className="aspect-w-4 aspect-h-3 bg-gray-200 relative overflow-hidden">
                  {product.images && ((product.images as unknown) as string[])[0] ? (
                    <img
                      src={((product.images as unknown) as string[])[0]}
                      alt={product.name}
